...
namespace cnab_services.arquivo
{
    public class ArquivoService : IArquivoService<CNAB>
    {
        ...
        public ArquivoService(IEnvironmentHelper enviromentHelper, IArquivoMapPosicao arquivoMapPosicao)
        {
        ...
        public async Task<ArquivoUploadResult<CNAB>> Upload(List<IFormFile> fileList)
        {
            ...
            foreach (var file in fileList)
            {
                ...
                var uploadFactory = ArquivoUploadFactory.Create(Enum.Parse<ArquivoUploadType>(extensaoArquivo.Replace(".", "").ToUpper()), file, _fileMaxSize, _arquivoMapPosicao);
